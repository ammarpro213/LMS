...
<li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="ViewEvaluationTaecher.php">View Evaluation Taecher</a></li>
					...
					<div class="col-md-6">
						...
						<form id="f1" runat="server" class ="form-light mt-20" role="form">
                            ...
                            <div class="form-group">
                            	...
                            	<input type="File" name="fileupload" class="form-control" placeholder=" Number">
                                
							</div>

                                <button class="btn btn-two">Upload</button>  
                            <br />
                             <label id="l1"></label>
