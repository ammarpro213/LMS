...
<header id="head" class="secondary" style="height: 200px;">
	...
	<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<h3 class="section-title">Manage Student</h3>
                       ...
                       $rr=mysqli_query($con,"select * from user where type=2");
                    ...
                    <tr>
                        ...
                        <td>'.$row['name'].'</td> 
                         ...
                         <td><a href="ManageStudent.php?de='.$row['id'].'" class="btn btn-danger" style="background-color: #d23c3c;">Delete</a></td>
