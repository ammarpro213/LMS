...
<head>
	...
	<title>Update Course File</title>
	...
	<div class="navbar navbar-inverse">
		<div class="container">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="AddCourseFile.php">Add courses Files </a></li>            
            </ul>
          </li>
					...
					<div class="col-md-6">
						...
						<form id="f1" runat="server" class ="form-light mt-20" role="form">
                            ...
                            <div class="form-group">
                            	...
                            	<input type="file" name="file" class="form-control" placeholder="Course file">
                                
							</div>

							  <div class="form-group">
                            	<label>Publish Date</label>
                            	<input type="Date" name="date" class="form-control" placeholder="Publish Date">
                            ...
                            <div class="form-group">
                            	...
                            	<input type="text" name="publish" class="form-control" placeholder="Publish name">
